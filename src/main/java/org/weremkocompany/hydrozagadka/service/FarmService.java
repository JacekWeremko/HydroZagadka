...
public class FarmService {
    ...
    public FarmService(FarmRepository farmRepository, MeasurementPHRepository measurementPHRepository, MeasurementRadiationRepository measurementRadiationRepository, MeasurementHumidityRepository measurementHumidityRepository) {
